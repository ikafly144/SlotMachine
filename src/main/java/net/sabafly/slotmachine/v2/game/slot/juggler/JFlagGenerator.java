...
import net.sabafly.slotmachine.v2.game.slot.Flag;
import net.sabafly.slotmachine.v2.game.slot.FlagGenerator;
import net.sabafly.slotmachine.v2.game.slot.Role;
import net.sabafly.slotmachine.v2.game.slot.Setting;
